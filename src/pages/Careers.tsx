...
export default function Careers() {
  ...
  return (
    <>
      <Seo
        title={t('seo.careers.title', 'Careers — Join the Estoria Team in Tallinn')}
        description={t('seo.careers.description', 'Explore career opportunities at Estoria. Join our team of premium real-estate brokers and advisors in Tallinn, Estonia.')}
        path="/careers"
      />
      {/* Header */}
      ...
      <section className="py-16 px-6 min-h-[50vh]">
        <div className="container mx-auto max-w-4xl">
          {isLoading ? (
            <div className="flex items-center justify-center py-32" role="status" aria-label={t('common.loading', 'Loading')}>
                ...
                >
                  ...
                  >
                    ...
                    <span className="flex items-center gap-2 text-xs text-muted-foreground group-hover:text-primary font-nav uppercase tracking-wider transition-colors shrink-0">
                      {t('careers.viewDetails')} <ArrowRight size={14} aria-hidden="true" />
                    </span>
                  </Link>
                </motion.div>
              ))}
            ...
            >
              <Mail className="text-primary mx-auto mb-6" size={40} aria-hidden="true" />
